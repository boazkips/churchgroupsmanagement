...
class DuplicateCalendarEvent extends StatefulWidget {
  const DuplicateCalendarEvent({super.key});

  @override
  State<DuplicateCalendarEvent> createState() => _DuplicateCalendarEventState();
}

class _DuplicateCalendarEventState extends State<DuplicateCalendarEvent> {
  int activeStep = 0;
