...
import 'package:churchgroupsmanagement/screens/minutes/meeting_info_confirmed.dart';
...
class SingleConfirmedMeeting extends StatefulWidget {
  const SingleConfirmedMeeting({super.key});

  @override
  State<SingleConfirmedMeeting> createState() => _SingleConfirmedMeetingState();
}

class _SingleConfirmedMeetingState extends State<SingleConfirmedMeeting> {
  @override
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            SizedBox(
              width: ScreenDimension().screenWidth(context) * 0.65,
              child: const Column(
          ...
          PopupMenuItem(
            onTap: () {
              Navigator.of(context).push(CupertinoPageRoute(builder: (context) {
                return const ConfirmedSingleMeetingInfo();
              }));
            },
            child: Row(
              children: [
