...
import 'package:churchgroupsmanagement/screens/minutes/edit_draft_meeting.dart';
import 'package:churchgroupsmanagement/screens/minutes/edit_selected_minute.dart';
import 'package:churchgroupsmanagement/screens/minutes/meeting_info_draft.dart';
...
class SingleDraftMeeting extends StatefulWidget {
  const SingleDraftMeeting({super.key});

  @override
  State<SingleDraftMeeting> createState() => _SingleDraftMeetingState();
}

class _SingleDraftMeetingState extends State<SingleDraftMeeting> {
  @override
      ...
      itemBuilder: (context) {
        return [
          ...
          PopupMenuItem(
            onTap: () {
              Navigator.of(context).push(CupertinoPageRoute(builder: (context) {
                return const DraftSingleMeetingInfo();
              }));
            },
            child: Row(
              children: [
          ...
          PopupMenuItem(
            onTap: () {
              CoolAlert.show(
                ...
                title: "Are you sure?",
                text:
                    "You are about to publish this meeting to the database. You will not be able to make any more changes once published!",
            ...
            child: Row(
              children: [
                SvgPicture.asset(
                  "assets/icons/cloud_upload_outline.svg",
                  width: 15,
                  height: 15,
                  fit: BoxFit.cover,
                ),
                const SizedBox(width: 8),
                const Text("Publish Minutes"),
              ],
            ),
          ),
